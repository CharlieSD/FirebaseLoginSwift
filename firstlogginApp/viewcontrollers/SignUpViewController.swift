...
class SignUpViewController:UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        continueButton = RoundedWhiteButton(frame: CGRect(x: 0, y: 0, width: 200, height: 32))
            ...
            if error == nil && user != nil {
                ...
                changeRequest?.commitChanges { error in
                    if error == nil {
                        ...
                        self.alert(title: "Error al crear nuevo usuario", message: error!.localizedDescription)
                    }
                }
            } else {
